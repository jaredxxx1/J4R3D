...
\033[1;37;1m
\033[1;37;1m-----------------------------------------------
\t      \033[1;37m\033[1;41m BOBO SI VLAD \033[0m\033[1;37m
\033[1;37;1m-----------------------------------------------
\033[1;37;1m ▶ Author   : JARED
\033[1;37;1m ▶ Facebook : JARED PELAGIO
\033[1;37;1m ▶ Version   : 0.01
\033[1;37;1m-----------------------------------------------""" )
def my_main():
    os.system("clear")
    print(logo)
...
def cloning_two():
  ...
  #  print(50*'-')
    ...
    print(" [•] WAG MASYADONG APURADO MAPANGHE")
    print("\033[1;37m[-] USE AIRPLANE MODE FOR SPEED UP\033[1;37m")
...
def pak():
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        print(f'\033[1;37m [-] WAG MASYADONG APURADO MAPANGHE\033[1;97m')
                        print("\033[1;37m[-] USE AIRPLANE MODE FOR SPEED UP\033[1;37m")
                        print("--------------------------------------------------")
                        for psx in user:
                                ids = code+psx
...
def gmail():
                ...
                with tred(max_workers=30) as Aking:
                        ...
                        print("\033[1;37m[-] WAG MASYADONG APURADO MAPANGHE\033[1;37m")
                        print("\033[1;37m[-] USE AIRPLANE MODE FOR SPEED UP\033[1;37m")
                        l1()
                        for user in fo:
